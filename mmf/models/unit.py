...
class UniT(BaseModel):
    ...
    def build(self):
        ...
        for dataset_name in self.config.datasets["detection"]:
            if dataset_name not in self.config.detr_args.num_queries["detection"]:
                continue
        ...
        for dataset_name in self.config.datasets["vl"]:
        ...
        for dataset_name in self.config.datasets["glue"]:
